			...
			<h1 id="top_page_title">Conditions</h1>
			<article>
				<div>
				...
				<div>
					<h2>Clause n° 5 : Modalites de paiement</h2>
					<p>
				...
				<div>
					...
					<p>
						...
						<span>Articles 441-6, I alinéa 12 et D. 441-5 du code de commerce.</span>
					</p>
				</div>
				<div>
					<h2>Clause n° 7 : Clause resolutoire</h2>
					<p>
				...
				<div>
					<h2>	Clause n° 11 : Tribunal competent</h2>
					<p>
